...
As long as you have a pc, with node, npm and electron running you are good to go!
...
npm start
```
Now development window will open.
...
For the versions available, see the [https://github.com/07souravkunda/electron-editor.git]. 
